<template>
    <div>
        ...
        <div>
            <b-table striped :items="actas" :fields="fields" :filter="busqueda" small head-variant="dark" empty-filtered-text="No se han encontrado actas que coincida con su criterio de búsqueda" empty-text="Aún no se han registrado actas" show-empty hover>
