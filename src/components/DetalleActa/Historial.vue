<template>
    <b-modal id="modal-historial" title="Historial" @show="show" hide-footer size="lg">
    ...
    export default {
        ...
        methods: {
            show(){
                ...
                axios
                .get(process.env.VUE_APP_API_URL + 'historial_acta/' + this.$route.params.id)
                .then(response => {
                    ...
                    this.fields = response.data.fields
                     ...
                     this.items.forEach(element => {
                        element.link_descarga = process.env.VUE_APP_API_URL + 'descargar_archivo_correo_acta/' + element.id
                    });
                })
